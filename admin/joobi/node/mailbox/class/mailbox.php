...
class Mailbox_Mailbox_class extends WClasses {
	...
	public static $ignoreEmailA = array();
	...
	public function getMessageId() {
		return $this->_connector->getMessageId();
	}
	...
	public function ignoredEmail($emailA=array()) {
		if ( is_array( $emailA ) ) self::$ignoreEmailA = $emailA;
		else self::$ignoreEmailA = array( $emailA );
	}	
