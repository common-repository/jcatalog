...
function create() {
	...
	if ($option == 'content') $option = JOOBI_MAIN_APP;
	$commentO->delLink = 'index.php?option=com_' . $option . '&controller=comment&task=delete&eid='.$commentO->tkid.'&etid='.$etid.'&score='.$score.'&returnid='.$realVal;
