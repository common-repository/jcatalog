...
<?php endif; ?>
<?php if ( $biddingEnded = $this->getValue('biddingEnded') ): ?>
<div class="<?php echo WPref::load( 'PAUCTION_NODE_EXPIREDSTYLE' ); ?> <?php echo WPref::load( 'PAUCTION_NODE_EXPIREDPOSITION' ); ?> badge<?php echo WPref::load( 'PAUCTION_NODE_EXPIREDCOLOR' ); ?>"><span><?php echo $biddingEnded; ?></span></div>
<?php endif; ?>
<?php if ( $biddingEnded = $this->getValue('biddingExpired') ): ?>
<div class="<?php echo WPref::load( 'PAUCTION_NODE_ENDSTYLE' ); ?> <?php echo WPref::load( 'PAUCTION_NODE_ENDPOSITION' ); ?> badge<?php echo WPref::load( 'PAUCTION_NODE_ENDCOLOR' ); ?>"><span><?php echo $biddingEnded; ?></span></div>
<?php endif; ?>
<?php if ( $auctionSold = $this->getValue('auctionSold') ): ?>
<div class="<?php echo WPref::load( 'PAUCTION_NODE_SOLDSTYLE' ); ?> <?php echo WPref::load( 'PAUCTION_NODE_SOLDPOSITION' ); ?> badge<?php echo WPref::load( 'PAUCTION_NODE_SOLDCOLOR' ); ?>"><span><?php echo $auctionSold; ?></span></div>
<?php endif; ?>
					<div id="ImageBox">
					<?php echo $itemImage; ?>
					</div>
			...
			<div id="siteContent" class="col-md-<?php echo $colWith; ?>">
				...
				<h2 class="title">
					<cite itemprop="name"><?php echo $itemName; ?></cite>
				</h2>
				</div>
				<?php endif; ?>
				<?php
					...
					$syndicateLink = $this->getValue('syndicateLink');
										$shwoControlButton = $editButton || $syndicateLink;						if ( !empty($shwoControlButton) ) :
				?>
				<div id="editable">
					<div class="btn-group">
					<?php
					if ( !empty($editButton) ) :
						...
						$buttonO->id = 'editBtn' . $this->getValue('pid');
						...
						$buttonO->id = 'dltBtn' . $this->getValue('pid');
				...
				<?php endif; ?>
				<?php if ( $progressBar = $this->getValue('targetBar') ) : ?>
					<div id="cartTarget">
				...
				<?php endif; ?>
				<?php
				$showCategory = $this->getValue( 'showCategory' );
				if ( !empty($showCategory) ) :
				$showCategoryLabel = $this->getValue( 'showCategoryLabel' );
				?>
				<div id="categoryInfo">
					<?php echo $showCategoryLabel . ': ' . $showCategory; ?>
				</div>
				<?php endif; ?>				
				<?php
				if ( $unpublishCountDown = $this->getValue( 'unpublishCountDown' ) ) :
				?>
				<div id="unpublishInfo">
					<?php echo '<div class="unpublishInfoText">' . $this->getValue( 'unpublishCountDownText' ) . ': </div>' . $unpublishCountDown; ?>
				</div>
				<?php endif; ?>
				<?php if ( $pageParams->showIntro && $shortDesc = $this->getRowContent('itemintroduction') ) : ?>
				<div id="siteIntroduction" class="clearfix">
					<div itemprop="description" class="siteIntroductionContent text-muted">
						<?php echo $shortDesc; ?>
					</div>
				</div>
				<?php endif; ?>
				...
				<?php endif; ?>
					...
					<div id="siteAuction">
						<div id="cartContainer">
							<div class="row">
								<div id="auctionBidDate" class="col-xs-4"><?php echo $this->getValue('biddingdatetitle'); ?></div>
								<div id="auctionBidDateDetail" class="col-xs-8"><?php echo $this->getValue('biddingdate'); ?></div>
							</div>
							<?php if ($bidCount = $this->getContent('bidcount')) : ?>									
								<div class="row">
									<div id="auctionBidCount" class="col-xs-4"><?php echo $this->getTitle('bidcount'); ?></div>
									<div id="auctionBidCountDetail" class="col-xs-8"><?php echo $bidCount; ?></div>							
								</div>
								<?php endif; ?>
							<div class="row">
								<div id="auctionBidValue" class="col-xs-4"><?php echo $this->getValue('showbidtitle'); ?></div>
								<div id="auctionBidValueDetail" class="col-xs-8"><?php echo $this->getValue('showbid'); ?></div>							
							</div>
							<?php if ( !$this->getValue( 'winbid' ) ) : ?>
								<?php if ( $approxateText = $this->getRowContent('approximatebid') ) : ?>
									<div class="row">
										<div id="auctionApproxBid" class="col-xs-4"></div>
										<div id="auctionApproxBidDetail" class="col-xs-8"><?php echo $approxateText; ?></div>							
									</div>
									<?php endif; ?>
								<?php $placeBidButton = $this->getRowContent('placebid'); ?>
								<?php if ( $showBiddingDetails ) : ?>
									<div class="row">
										<div id="auctionBid" class="col-xs-4"><?php echo $this->getTitle('itembidbox'); ?></div>
										<div id="auctionBidDetail" class="col-xs-8">
								...
								<?php if ( $placeBidButton && $showBiddingDetails ) : ?>
									<div class="row">
										<div id="auctionNotice" class="col-xs-4"></div>
										<div id="auctionNoticeDetail" class="col-xs-8"><?php echo $this->getRowContent('bidnotice'); ?></div>							
									</div>
									<?php endif; ?>
								<?php
									...
									<div class="row">
										<div id="auctionBuyNowPrice" class="col-xs-4"><?php echo $this->getTitle('itemprice'); ?></div>
										<div id="auctionBuyNowButton" class="col-xs-8"><span><?php echo $itemPrice; ?></span><div class="auctionBuyNowBttn"><?php echo $this->getRowContent('addtocart'); ?></div></div>
									</div>
									<?php endif; ?>
								<?php endif; ?>
							<?php if ( $shippingMethod = $this->getValue('shippingMessage') ) : ?>								
								<div class="row">
									<div id="auctionShippingMessage"><div id="siteShipping"><?php echo $shippingMethod; ?></div></div>
									<div class="col-xs-4"></div>
									<div id="auctionShippingMessage" class="col-xs-8"><?php echo $this->getRowContent('bidnotice'); ?></div>							
								</div>
								<?php endif; ?>
							<?php if ( !$this->getValue( 'winbid' ) && $auctionFee = $this->getValue('auctionFeePrice') ) : ?>
								<div class="row">
									<div id="auctionFeeText" class="col-xs-4"><?php echo $this->getValue('auctionFeeText'); ?></div>>
									<div id="auctionFeePrice" class="col-xs-8"><div id="auctionFee"><?php echo $auctionFee; ?></div></div>
								</div>
								<?php endif; ?>
						</div>			
					</div>
				...
				<?php 
				$manuTitle = $this->getValue( 'manufacturerTitle' );
				if ( $pageParams->showAskQuestion || $pageParams->showVendor || $manuTitle ) : ?>
				<div id="siteVendor">
					<?php
					...
					<?php if ( $manuTitle ) : ?>
					<h5 class="siteName">
						<?php echo $manuTitle . ' : ' . $this->getValue( 'manufacturerName' ); ?>
					</h5>
					<?php endif; ?>
				</div>
				<?php endif; ?>
