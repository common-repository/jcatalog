			...
			<div id="siteContent" class="col-md-<?php echo $colWith; ?>">
				...
				<?php if ( $pageParams->showPrice ) :
					...
					?>
						<div id="cartOption" class="priceLayout clearfix">
							...
							foreach( $allOptionsA as $oneOption ) {
								if ( !empty($oneOption->description) ) {
									$toolTipsO = WPage::newBluePrint( 'tooltips' );
									$toolTipsO->tooltips = $oneOption->description;
									$toolTipsO->text = $oneOption->name;
									$oneOption->name = WPage::renderBluePrint( 'tooltips', $toolTipsO );
								}							?>
					...
					<?php
						...
						$itemDiscountedCount = $this->getValue('discountExpire');
					...
					<div id="sitePrice" class="priceLayout clearfix">
						<div class="control-group">
							...
							<div class="controls">
								<div class="productCurrency<?php echo $this->getValue('priceDiscountClass'); ?>"> <?php echo $itemPrice; ?> </div>
								<?php if ( $itemDiscountedPrice ): ?>
								<div id="productDiscount"> <?php echo $itemDiscountedPrice; ?> </div>
								<div id="productDiscountSaved"> <?php echo $this->getValue('onSaleYouSave') . ': ' . $this->getValue('onSaleYouSaveValue') . $onSalePercent; ?> </div>
								<?php endif; ?>
								<?php if ( $itemDiscountedCount ): ?>
								<div id="productDiscountCount"><div class="productDiscountCountText"> <?php echo $this->getValue('discountExpireText') . ': </div>' . $itemDiscountedCount; ?> </div>
								<?php endif; ?>
							</div>
						</div>
					</div>
					...
					<?php endif; ?>
					<?php if ( $itemPrice ) : ?>
					<div id="siteTotal" itemprop="offers" itemscope itemtype="http://schema.org/Offer" class="priceLayout clearfix">
						<div class="control-group">
							<label class="control-label">
							<span><?php echo $this->getTitle('itemtotal'); ?></span>
							</label>
							<div class="controls">
							<span itemprop="price" id="productTotalValue" class="productCurrency priceTotal<?php echo $this->getValue('priceDiscountClass'); ?>"> <?php echo $itemPriceTotal; ?> </span>
							</div>
						</div>
					</div>
					<?php endif; ?>
